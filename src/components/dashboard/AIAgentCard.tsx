...
const AIAgentCard = () => {
  ...
  return <Card className="monday-card hover:shadow-monday transition-all duration-300">
      <CardContent className="p-4 space-y-4">
        ...
        <div>
          ...
          <div className="flex space-x-2">
            ...
            return <div key={platform.name} className="p-2 bg-white rounded-lg shadow-sm border border-monday-gray-200 hover:shadow-md transition-all duration-200 hover:scale-105">

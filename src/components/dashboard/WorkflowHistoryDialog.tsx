    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[80vh] flex flex-col">
        ...
        <Tabs defaultValue="categories" className="w-full">
          ...
          <TabsContent value="categories" className="space-y-2 animate-fade-in">
                  ...
                  <Button
                    ...
                    className={`text-xs h-8 transition-all duration-300 ${
                      selectedCategory === category.value
                        ? 'bg-blue-600 hover:bg-blue-700 text-white border-blue-600 transform scale-105 shadow-md'
          ...
          <TabsContent value="statuses" className="space-y-2 animate-fade-in">
            <div className="flex flex-wrap gap-2">
              {statuses.map(status => {
                  ...
                  <Button
                    ...
                    className={`text-xs h-8 transition-all duration-300 ${
                      selectedStatus === status.value
                        ? 'bg-green-600 hover:bg-green-700 text-white border-green-600 transform scale-105 shadow-md'
          ...
          <div className="space-y-3 animate-fade-in">
            {filteredHistory.map((item, index) => {
              ...
              return (
                <div 
                  key={item.id} 
                  className="p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all duration-300 hover:shadow-md hover:scale-[1.02] animate-fade-in"
